...
export default class News extends Component {
  ...
  async componentDidMount() {
    try {
      let url =
        "https://newsapi.org/v2/everything?q=tesla&from=2026-04-24&sortBy=publishedAt&apiKey=5da591db591a4c2488c42a12b2bef658&page=1";
  ...
  handleNextPage = async () => {
    ...
    let url = `https://newsapi.org/v2/everything?q=tesla&from=2026-04-24&sortBy=publishedAt&apiKey=5da591db591a4c2488c42a12b2bef658&page=${nextPage}`;
  ...
  handleBackPage = async () => {
    ...
    let url = `https://newsapi.org/v2/everything?q=tesla&from=2026-04-24&sortBy=publishedAt&apiKey=5da591db591a4c2488c42a12b2bef658&page=${backPage}`;
